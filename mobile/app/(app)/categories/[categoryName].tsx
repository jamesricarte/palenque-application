...
import { useCategoryDetails } from "@/src/features/app/categories/useCategoryDetails";
import CategoryDetailsLoadingSkeleton from "@/src/features/app/categories/components/CategoryDetailsLoadingSkeleton";
  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      ...
      <View className="flex-row items-center px-5 pt-2 pb-5 border-b border-white-600">
        ...
        {/* <Text className="flex-1 text-[22px] font-semibold text-black-500 bg-red-500">
          {bannerTitle}
        </Text> */}
      ...
      >
        {loading ? (
          <CategoryDetailsLoadingSkeleton />
        ) : (
          <>
            <View className="overflow-hidden rounded-[24px] bg-[#fff4ef]">
              <View className="h-48">
                {bannerImage ? (
                  ...
                  <View className="items-center justify-center w-full h-full bg-[#fde8e1]">
                    <Ionicons name="grid-outline" size={48} color="#f16b44" />
                  </View>
                )}
              </View>
              ...
              <View className="px-5 py-5">
                ...
                <Text className="mt-2 text-base leading-6 text-white-700">
                  Explore the most popular products and trusted vendors in this
                  section, just like walking through a dedicated lane in your local
                  public market.
                </Text>
              </View>
            </View>
            ...
            {isCategoryMissing ? (
              <View className="items-center px-6 py-12 mt-6 border rounded-2xl border-white-600">
                ...
                <Text className="mt-2 text-base leading-6 text-center text-white-700">
                  We couldn&apos;t load this category section right now.
                </Text>
              </View>
            ) : (
              <>
                ...
                <View className="mt-7">
                  ...
                  {topVendors.length === 0 ? (
                    <View className="items-center px-6 py-10 mt-3 border rounded-2xl border-white-600">
                      ...
                      />
                      <Text className="mt-3 text-base text-center text-white-700">
                        No vendors are featured in this category yet.
                      </Text>
                    </View>
                  ) : (
