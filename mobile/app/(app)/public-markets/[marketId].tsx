...
import PublicMarketDetailsLoadingSkeleton from "@/src/features/app/public-markets/components/PublicMarketDetailsLoadingSkeleton";
...
const PublicMarketDetailsScreen = () => {
  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      ...
      >
        {loading ? (
          <PublicMarketDetailsLoadingSkeleton />
        ) : (
          <>
