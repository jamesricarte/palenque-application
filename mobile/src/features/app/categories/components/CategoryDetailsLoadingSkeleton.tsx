...
const CategoryDetailsLoadingSkeleton = () => {
  return (
    <>
          ...
          {Array.from({ length: 2 }).map((_, index) => (
            ...
            >
              ...
              <View className="px-4 py-3">
                <Skeleton width={108} height={14} borderRadius={999} />

                <View className="mt-2">
                  <Skeleton width={82} height={10} borderRadius={999} />
                </View>
      ...
      <View className="mt-7">
        <Skeleton width={168} height={20} borderRadius={999} />
          ...
          {Array.from({ length: 2 }).map((_, index) => (
            ...
            >
              ...
              <View className="flex-1 ml-3">
                <Skeleton width={132} height={16} borderRadius={999} />
...
export default CategoryDetailsLoadingSkeleton;
